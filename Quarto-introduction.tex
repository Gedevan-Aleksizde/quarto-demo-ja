...
\begin{tcolorbox}[colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulbO}\hspace{0.5em}Tip, toptitle=1mm, arc=.35mm, bottomtitle=1mm, titlerule=0mm, left=2mm, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, coltitle=black, bottomrule=.15mm, colframe=quarto-callout-tip-color]
...
\begin{tcolorbox}[colback=white, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}重要, toptitle=1mm, arc=.35mm, bottomtitle=1mm, titlerule=0mm, left=2mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, coltitle=black, bottomrule=.15mm, colframe=quarto-callout-important-color]
