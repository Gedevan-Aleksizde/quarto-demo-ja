...
\begin{tcolorbox}[titlerule=0mm, coltitle=black, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulbO}\hspace{0.5em}Tip, bottomrule=.15mm, arc=.35mm, toptitle=1mm, colback=white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, colframe=quarto-callout-tip-color, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[titlerule=0mm, coltitle=black, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}重要, bottomrule=.15mm, arc=.35mm, toptitle=1mm, colback=white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, colframe=quarto-callout-important-color, colbacktitle=quarto-callout-important-color!10!white]
